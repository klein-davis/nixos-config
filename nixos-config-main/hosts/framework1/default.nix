{ pkgs, config, ... }: 
{
  ...
  # Set the default lid behavior to do nothing.
  systemd.services.systemd-logind.serviceConfig.LidSwitchIgnoreInhibited = "no";
  systemd.services.systemd-logind.serviceConfig.HandleLidSwitch = "ignore";
  systemd.services.systemd-logind.serviceConfig.HandleLidSwitchExternalPower = "ignore";
  systemd.services.systemd-logind.serviceConfig.HandleLidSwitchDocked = "ignore";
